...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/vmware/terraform-provider-vcd.git
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vcd_v3.9.0
